...
STRATEGIES = {
    "Moving Average Strategy": {
        ...
        "params": [
            ...
            {"name": "initial_capital_val", "label": "Initial Capital", "type": "number_input", "default": 10000.0, "help": "Starting account balance."},
    ...
    "9 Sig Strategy": {
        ...
        "params": [
            ...
            {"name": "end_date", "label": "End Date", "type": "date_input", "default": "today", "help": "Ending date for the backtest."},
            {"name": "initial_capital_val", "label": "Initial Capital", "type": "number_input", "default": 10000.0, "help": "Starting portfolio balance."},
